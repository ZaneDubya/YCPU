...
namespace YCPU.Library.Support
{
    public class InputState
    {
        ...
        {
            m_TheTime = (float)gameTime.TotalGameTime.TotalSeconds;
        ...
        public bool HandleMouseEvent(MouseEvent type, YCPU.Library.Input.MouseButton mb)
        {
