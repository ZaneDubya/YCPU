...
namespace YCPU.Library.Graphics
{
    public struct VertexPositionTextureHueExtra : IVertexType
    {
        ...
        public VertexPositionTextureHueExtra(Vector3 position, Vector2 textureCoordinate)
        {
            ...
            Hue = Color.White;
            this.Extra = Vector2.Zero;
        }

        public VertexPositionTextureHueExtra(Vector3 position, Vector2 textureCoordinate, Color hue, Vector2 extra)
        {
            this.Position = position;
            this.TextureCoordinate = textureCoordinate;
            Hue = hue;
