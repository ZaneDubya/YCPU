...
namespace Ypsilon {
    public static class GraphicsUtility {
        ...
        public static Matrix CreateProjectionMatrixScreenCentered(GraphicsDevice graphics) {
            return Matrix.CreateOrthographicOffCenter(graphics.Viewport.Width / -2, graphics.Viewport.Width / 2, graphics.Viewport.Height / -2, graphics.Viewport.Height / 2, short.MinValue, short.MaxValue);
        }

        public static Matrix CreateProjectionMatrixScreenOffset(GraphicsDevice graphics) {
            return Matrix.CreateOrthographicOffCenter(0, graphics.Viewport.Width, graphics.Viewport.Height, 0, short.MinValue, short.MaxValue);
        }
    }
}