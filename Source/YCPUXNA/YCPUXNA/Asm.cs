...
namespace YCPUXNA
{
    class Asm
    {
        ...
        const string errWritingOutput = "yasm: Error writing machine code. Press any key to continue.";
        ...
        const string descFileWrittenPressKey = "yasm: File written. Press any key to continue.";
